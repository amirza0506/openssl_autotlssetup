...
void save_cert_key(X509 *cert, EVP_PKEY *pkey, const char *certfile, const char *keyfile)
{
...
void run_server(const char *certfile, const char *keyfile, const char *group, int port)
{
...
int main(int argc, char **argv)
{
    ...
    if (!mode) {
        printf("Specify --mode gen or --mode server\n");
        return 1;
    }
